---
id: webflowschema-condition
title: "Webflow JSON Schema: Condition"
---

## Condition

The condition object is used in various places throughout webflows. This condition object is a [CfFlow condition object](https://pixl8.github.io/cfflow/reference/schema/condition.html) and you should familiarize yourself with the [CfFlow condition concepts](https://pixl8.github.io/cfflow/guides/concepts.html).
...
```json
{
    ...
    "$id": "webflow.condition.schema.json",
    "type": "object",
