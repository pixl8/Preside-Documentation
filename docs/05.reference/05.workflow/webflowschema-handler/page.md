---
id: webflowschema-handler
title: "Webflow JSON Schema: Handler"
---

## Handler

The handler object is used in various places throughout webflows to define a Coldbox handler that will be run.
...
```json
{
    ...
    "$id": "webflow.handler.schema.json",
    "type": "object",
