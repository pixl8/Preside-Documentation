...
<div class="table-resp">
    <table class="table">
        ...
        <tbody>
            ...
            <tr><td>generator</td>            <td>No</td>  <td>"uuid"</td>    <td>Named generator for generating a value for this field when inserting/updating a record with the value of this field ommitted. See "Generated fields", below.</td>
            <tr><td>generate</td>             <td>No</td>  <td>"insert"</td>   <td>If using a generator, indicates when to generate the value. Valid values are "never", "insert" and "always".</td>
